                                ...
                                <div class="flex justify-center my-3">
                                    ...
                                    <h6 class="text-center text-white bg-emerald-800 rounded w-full py-2 my-3">Informacion del Producto</h6>
                                        <div class="flex justify-around my-3 w-full">
                                            <input
                                                type="text"
                                                class="form-input p-2 rounded-md w-6/12"
                                                placeholder="Nombre"
                                                v-model="form.name"
                                            />
                                            <input
                                                type="text"
                                                class="form-input rounded-md w-4/12 p-2"
                                                placeholder="Stock"
                                                v-model="form.stock"
                                            />
                                        </div>
                                        ...
                                        <div class="flex justify-around w-full">
                                            <div class="flex justify-center w-6/12 text-center align-center">
                                                <span
                                                    class="bg-gray-800 text-white w-2/12 my-3 align-middle rounded-l-md leading-10"
                                                    >$</span
                                                >
                                                <input
                                                    type="text"
                                                    class="form-input p-2 rounded-r-md w-6/12 my-3 block py-2 focus:border-slate-700"
                                            ...
                                            <div class="flex justify-center w-6/12 text-center align-center">
                                                ...
                                                <input
                                                    type="text"
                                                    class="form-input border p-2 rounded-r-md w-6/12 my-3 block py-2"
                                        ...
                                        <div class="flex flex-wrap">
                                            ...
                                            <div class="flex justify-start w-11/12 md:w-4/12 space-x-4" v-for="user in users" :key="user.id">
                                                <input type="radio" id="user_{{ user.id }}" class="rounded text-pink-500 m-r-2" name="user_id" v-model="form.user_id" :value="user.id">
