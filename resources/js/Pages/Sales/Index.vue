                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-10 w-10">
                                                                <Link :href=" route('products.edit', sale.id) ">
                                                            ...
                                                            <div class="ml-4">
                                                                <div class="text-sm font-medium text-gray-900">
                                                                    <span class="text-black-900 font-bold">{{ sale.id }} -</span>
                                                                </div>
                                                                <div class="text-sm" :class="{ 'text-green-500': sale.status >= 20, 'text-orange-500': sale.status <=19, 'text-red-500': sale.status <= 5 }">
                                                                    <span v-if="sale.status > 0 " class="itallic">
                                                                        {{ sale.status }}
                                                                    </span>
